...
//            "PaymentMode", "PaymentModeConfidence",
            "Merchant", "MerchantSegment",
//            "MerchantConfidence", "MerchantAnchorUsed",
            "FinancialEventType", "FinancialEventConfidence",
...
//                    escape(row.merchantAnchorUsed),
                    escape(row.financialEventType),
                    escape(row.financialEventConfidence),
                    escape(row.financialEventEvidence),
//                    escape(row.account),

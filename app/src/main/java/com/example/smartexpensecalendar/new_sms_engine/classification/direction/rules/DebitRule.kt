...
class DebitRule : ClassificationRule<TransactionDirection> {
    ...
    override fun evaluate(
        ...
        val matches = MatchUtils.findMatches(
            ...
            signals = DirectionKnowledge.DEBIT_SIGNALS
        )
        ...
        return ClassificationRuleResult(
            classification = TransactionDirection.DEBIT,
            score = ClassificationScores.STRONG_MATCH,
            evidence = listOf(
                ClassificationEvidence.DEBIT_SIGNAL
            ),
            matches = matches
        )
    }

...
data class AnalyzedSMS(
    ...
    val classifiedMessageType: String = "UNKNOWN",
    val classifiedMessageTypeConfidence: Int = 0,
    val classifiedMessageTypeScore: Int = 0,
    val classifiedMessageTypeEvidence: List<String> = emptyList(),
    val classifiedMessageTypeMatches: List<String> = emptyList(),

...
fun SMSLogEntity.toDomain() = SMSProcessingLog(smsId, sender, body, date, ProcessingStatus.valueOf(status), failureReason)
fun SMSProcessingLog.toEntity() = SMSLogEntity(smsId, sender, body, date, status.name, failureReason)
